...
import org.example.persist.CustomerRepository;
...
public class CustomerControllerServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        if (req.getPathInfo() == null || req.getPathInfo().equals("") || req.getPathInfo().equals("/")) {
            ...
            req.setAttribute("customer", new Customer(null, "New Customer name", "New Customer surname", "New Customer address", "New Customer phone"));
